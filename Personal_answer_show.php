...
<?php
    ...
    $sql1 = "SELECT * FROM thread_discuss WHERE user_id=$id";
    ...
    while($row1 = mysqli_fetch_assoc($result1)){
        ...
        <h5 class="mt-2 mb-0 pt-0"><a class="text-dark" href="thread.php?threadid='. $id .'">' . $thread_desc . '</a></h5>
        </div>
      </div>
        </div>
        ';
